...
class CombatEngine:
    ...
    def _potent_active(self, effects, is_attacker, made_fu, triggers_brave):
        best_mult = 0
        for e in effects:
            if e.type == EffectType.POTENT:
                """Determines the highest potent value based on whether or not the user makes a follow up or braves"""
